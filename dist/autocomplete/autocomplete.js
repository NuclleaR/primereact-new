...
this.primereact.autocomplete = (function (exports, React, PrimeReact, button, componentbase, hooks, chevrondown, spinner, timescircle, inputtext, overlayservice, tooltip, utils, csstransition, portal, ripple, virtualscroller) {
  ...
  var AutoComplete = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var findNextItem = function findNextItem(item) {
      ...
      return nextItem ? utils.DomHandler.getAttribute(nextItem, 'data-pc-section') === 'itemgroup' ? findNextItem(nextItem) : nextItem : null;
    };
    var findPrevItem = function findPrevItem(item) {
      var prevItem = item.previousElementSibling;
      return prevItem ? utils.DomHandler.getAttribute(prevItem, 'data-pc-section') === 'itemgroup' ? findPrevItem(prevItem) : prevItem : null;
    };
...
})({}, React, primereactnew.dist.api, primereactnew.dist.button, primereactnew.dist.componentbase, primereactnew.dist.hooks, primereactnew.dist.icons.chevrondown, primereactnew.dist.icons.spinner, primereactnew.dist.icons.timescircle, primereactnew.dist.inputtext, primereactnew.dist.overlayservice, primereactnew.dist.tooltip, primereactnew.dist.utils, primereactnew.dist.csstransition, primereactnew.dist.portal, primereactnew.dist.ripple, primereactnew.dist.virtualscroller);
