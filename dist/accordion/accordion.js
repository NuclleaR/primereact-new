...
this.primereact.accordion = (function (exports, React, api, componentbase, csstransition, hooks, chevrondown, chevronright, utils) {
  ...
  var Accordion = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var findNextHeaderAction = function findNextHeaderAction(tabElement) {
      ...
      return headerElement ? utils.DomHandler.getAttribute(headerElement, 'data-p-disabled') ? findNextHeaderAction(headerElement.parentElement) : utils.DomHandler.findSingle(headerElement, '[data-pc-section="headeraction"]') : null;
    };
    var findPrevHeaderAction = function findPrevHeaderAction(tabElement) {
      ...
      return headerElement ? utils.DomHandler.getAttribute(headerElement, 'data-p-disabled') ? findPrevHeaderAction(headerElement.parentElement) : utils.DomHandler.findSingle(headerElement, '[data-pc-section="headeraction"]') : null;
    };
